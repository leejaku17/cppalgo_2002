...
void DrawRadixTrieMap::Draw(CDC *pDC, const RECT& rt, bool bDrawTail)
{
...
void DrawRadixTrieMap::_DrawNode(CDC *pDC, Node *p, int x1, int x2, int y, bool bDrawTail, int b)
{
	if (p != m_pNodeTail)
	{
...
void DrawRadixTrieMap::_DrawLink(CDC *pDC, Node *p, int x1, int x2, int y, bool bDrawTail)
{
	if (p != m_pNodeTail)
	{
...
CString DrawRadixTrieMap::_MakeBits(int x, int b)
{
	CString strResult;
